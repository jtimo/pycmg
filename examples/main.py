...
my_configuration = Configuration(vf_max_assembly=0.3, mesostructure_size=[20, 20, 20], resolution=[0.125, 0.125, 0.125])
my_configuration.configure_inclusions(conf_csv='AB8_CMG.csv')
my_mesostructure = Mesostructure(my_configuration)
