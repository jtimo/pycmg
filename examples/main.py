# -*- coding: utf-8 -*-
import sys,os
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../pycmg/'))
...
my_configuration = Configuration(vf_max_assembly=0.45, average_shape=[1, 0.5, 0.5])
my_configuration.load_inclusions(conf_csv=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'AB8_CMG_full.csv'))
